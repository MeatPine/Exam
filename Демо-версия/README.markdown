...
## Задача 2: Минимальная грузоподъёмность грузовика
...
В первой строке вводятся натуральные числа N и M — количество баз и троп (0 < N, M < 10^5), нумерация баз начинается с 0, N – 1 база располагается на вершине.  
